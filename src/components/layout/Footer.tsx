        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="flex flex-col items-center md:items-start">
            <Link href="/" className="flex items-center gap-2">
               <Image src="https://images.unsplash.com/photo-1762105069666-1f8ca2dd815a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=880" alt="Enactus Hansraj Logo" width={140} height={40} />
            </Link>
             ...
             <div>
                <h3 className="font-headline font-semibold">Connect</h3>
                 <ul className="mt-4 space-y-2">
                    ...
                    <li><a href="https://enactimes.kit.com/6648f55af3" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary">Newsletter</a></li>
                 </ul>
             </div>
          </div>
